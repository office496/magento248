<?php return array (
  ...
  array (
    ...
    array (
      ...
      'mollie_customer_id_extension_attributes' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Customer\\CustomerId',
      ),
    ),
    ...
    array (
      'mollie_add_mealvoucher_category_to_loaded_attribute' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Catalog\\Model\\AddMealVoucherCategoryToLoadedAttributes',
      ),
    ),
    ...
    array (
      ...
      'mollie_add_paymentfee_extension_attributes' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Sales\\Cart\\AddPaymentFeeToCart',
      ),
    ),
    ...
    array (
      ...
      'mollie_payment_fee_order' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Sales\\AddPaymentFeeToOrder',
      ),
      'mollie_payment_add_subscription_data' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Sales\\AddRecurringData',
      ),
    ),
    ...
    array (
      ...
      'mollie_order_management-plugin' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Sales\\Api\\OrderManagementPlugin',
      ),
    ),
    ...
    array (
      'mollie_parse_metadata' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Quote\\Api\\ParseMollieMetadata',
      ),
    ),
    'Magento\\Quote\\Api\\Data\\CartItemInterface' => 
    array (
      'mollie_make_recurring_products_unique_in_cart' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Quote\\Api\\Item\\MakeRecurringProductsUniqueInCart',
      ),
    ),
    'Magento\\Framework\\View\\Asset\\Minification' => 
    array (
      'disable_minification_for_components_js' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Framework\\View\\Asset\\DisableMinificationForComponentsJs',
      ),
    ...
    array (
      'mollie_hide_methods_that_are_not_allowed' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Quote\\Api\\PaymentMethodManagementPlugin',
      ),
      'mollie_hide_methods_when_cart_contains_recurring_product' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Quote\\Api\\LimitMethodsForRecurringPayments',
      ),
    ),
    'Magento\\Config\\Model\\Config\\Loader' => 
    array (
      'mollie_load_correct_group' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\Config\\LoadCorrectGroup',
      ),
    ),
    'Magento\\InstantPurchase\\Controller\\Button\\PlaceOrder' => 
    array (
      'mollie_add_redirect_url' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\InstantPurchase\\Button\\PlaceOrderAddRedirectUrl',
      ),
    ),
    'Magento\\InventorySales\\Model\\IsProductSalableForRequestedQtyCondition\\IsSalableWithReservationsCondition' => 
    array (
      'mollie_disable_stock_check_for_admin_orders' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\InventorySales\\Model\\IsProductSalableForRequestedQtyCondition\\IsSalableWithReservationsCondition\\DisableCheckForAdminOrders',
      ),
    ),
    'Magento\\CustomerBalance\\Observer\\RevertStoreCreditObserver' => 
    array (
      'mollie_prevent_double_credit_revert' => 
      array (
        'sortOrder' => 0,
        'instance' => 'Mollie\\Payment\\Plugin\\CustomerBalance\\Observer\\PreventDoubleCreditRevert',
      ),
    ),
  ...
  array (
    ...
    'mollieLogger' => NULL,
    'Mollie\\Payment\\Ui\\DataProvider\\PaymentReminder\\Listing\\Pending\\Collection' => 
    array (
      'currentPageDetection' => 
      array (
        'sortOrder' => 0,
    ...
    'PendingPaymentReminderCollection' => 
    array (
      'currentPageDetection' => 
      array (
        'sortOrder' => 0,
    ...
    'Mollie\\Payment\\Ui\\DataProvider\\PaymentReminder\\Listing\\Sent\\Collection' => 
    array (
      'currentPageDetection' => 
      array (
        'sortOrder' => 0,
    ...
    'ScandiPWA\\Router\\Controller\\Router' => NULL,
    'ScandiPWA\\Router\\Controller\\ConfigurableRouter' => NULL,
    'MollieApplePayValueHandlerPool' => NULL,
    'MollieApplePayConfigValueHandler' => NULL,
    'MollieApplePayConfig' => NULL,
    'Magento\\Payment\\Gateway\\Validator\\ValidatorPoolInterface' => NULL,
    'Magento\\Payment\\Gateway\\Validator\\ValidatorPool' => NULL,
    'MollieApplePayValidatorPool' => NULL,
    ...
    'MollieApplePayCountryValidator' => NULL,
    'MollieAlmaValueHandlerPool' => NULL,
    'MollieAlmaConfigValueHandler' => NULL,
    'MollieAlmaConfig' => NULL,
    'MollieAlmaValidatorPool' => NULL,
    'MollieAlmaCountryValidator' => NULL,
    'MollieBancontactValueHandlerPool' => NULL,
    'MollieBancontactConfigValueHandler' => NULL,
    'MollieBancontactConfig' => NULL,
    'MollieBancontactValidatorPool' => NULL,
    'MollieBancontactCountryValidator' => NULL,
    'MollieBancomatpayValueHandlerPool' => NULL,
    'MollieBancomatpayConfigValueHandler' => NULL,
    'MollieBancomatpayConfig' => NULL,
    'MollieBancomatpayValidatorPool' => NULL,
    'MollieBancomatpayCountryValidator' => NULL,
    'MollieBanktransferValueHandlerPool' => NULL,
    'MollieBanktransferConfigValueHandler' => NULL,
    'MollieBanktransferConfig' => NULL,
    'MollieBanktransferValidatorPool' => NULL,
    'MollieBanktransferCountryValidator' => NULL,
    'MollieBelfiusValueHandlerPool' => NULL,
    'MollieBelfiusConfigValueHandler' => NULL,
    'MollieBelfiusConfig' => NULL,
    'MollieBelfiusValidatorPool' => NULL,
    'MollieBelfiusCountryValidator' => NULL,
    'MollieBillieValueHandlerPool' => NULL,
    'MollieBillieConfigValueHandler' => NULL,
    'MollieBillieConfig' => NULL,
    'MollieBillieValidatorPool' => NULL,
    'MollieBillieCountryValidator' => NULL,
    'MollieBlikValueHandlerPool' => NULL,
    'MollieBlikConfigValueHandler' => NULL,
    'MollieBlikConfig' => NULL,
    'MollieBlikValidatorPool' => NULL,
    'MollieBlikCountryValidator' => NULL,
    'MollieCreditcardCommandPool' => NULL,
    'MollieCreditcardValueHandlerPool' => NULL,
    'MollieCreditcardConfigValueHandler' => NULL,
    'MollieCreditcardConfig' => NULL,
    'MollieCreditcardValidatorPool' => NULL,
    'MollieCreditcardCountryValidator' => NULL,
    'MollieCreditcardVaultValueHandlerPool' => NULL,
    'Mollie\\Payment\\Model\\Data\\CreditcardVaultConfig' => NULL,
    'MollieCreditcardVaultConfig' => NULL,
    'MollieCreditcardVaultValidatorPool' => NULL,
    'MollieCreditcardVaultCountryValidator' => NULL,
    'MollieCreditcardVaultAuthorizeCommand' => NULL,
    'MollieDirectdebitValueHandlerPool' => NULL,
    'MollieDirectdebitConfigValueHandler' => NULL,
    'MollieDirectdebitConfig' => NULL,
    'MollieDirectdebitValidatorPool' => NULL,
    'MollieDirectdebitCountryValidator' => NULL,
    'MollieEpsValueHandlerPool' => NULL,
    'MollieEpsConfigValueHandler' => NULL,
    'MollieEpsConfig' => NULL,
    'MollieEpsValidatorPool' => NULL,
    'MollieEpsCountryValidator' => NULL,
    'MollieGiftcardValueHandlerPool' => NULL,
    'MollieGiftcardConfigValueHandler' => NULL,
    'MollieGiftcardConfig' => NULL,
    'MollieGiftcardValidatorPool' => NULL,
    'MollieGiftcardCountryValidator' => NULL,
    'MollieGooglePayValueHandlerPool' => NULL,
    'MollieGooglePayConfigValueHandler' => NULL,
    'MollieGooglePayConfig' => NULL,
    'MollieGooglePayValidatorPool' => NULL,
    'MollieGooglePayCountryValidator' => NULL,
    'MollieIdealValueHandlerPool' => NULL,
    'MollieIdealConfigValueHandler' => NULL,
    'MollieIdealConfig' => NULL,
    'MollieIdealValidatorPool' => NULL,
    'MollieIdealCountryValidator' => NULL,
    'MollieIn3ValueHandlerPool' => NULL,
    'MollieIn3ConfigValueHandler' => NULL,
    'MollieIn3Config' => NULL,
    'MollieIn3ValidatorPool' => NULL,
    'MollieIn3CountryValidator' => NULL,
    'MollieKbcValueHandlerPool' => NULL,
    'MollieKbcConfigValueHandler' => NULL,
    'MollieKbcConfig' => NULL,
    'MollieKbcValidatorPool' => NULL,
    'MollieKbcCountryValidator' => NULL,
    'MollieKlarnaValueHandlerPool' => NULL,
    'MollieKlarnaConfigValueHandler' => NULL,
    'MollieKlarnaConfig' => NULL,
    'MollieKlarnaValidatorPool' => NULL,
    'MollieKlarnaCountryValidator' => NULL,
    'MollieKlarnapaylaterValueHandlerPool' => NULL,
    'MollieKlarnapaylaterConfigValueHandler' => NULL,
    'MollieKlarnapaylaterConfig' => NULL,
    'MollieKlarnapaylaterValidatorPool' => NULL,
    'MollieKlarnapaylaterCountryValidator' => NULL,
    'MollieKlarnapaynowValueHandlerPool' => NULL,
    'MollieKlarnapaynowConfigValueHandler' => NULL,
    'MollieKlarnapaynowConfig' => NULL,
    'MollieKlarnapaynowValidatorPool' => NULL,
    'MollieKlarnapaynowCountryValidator' => NULL,
    'MollieKlarnasliceitValueHandlerPool' => NULL,
    'MollieKlarnasliceitConfigValueHandler' => NULL,
    'MollieKlarnasliceitConfig' => NULL,
    'MollieKlarnasliceitValidatorPool' => NULL,
    'MollieKlarnasliceitCountryValidator' => NULL,
    'MollieMbWayValueHandlerPool' => NULL,
    'MollieMbWayConfigValueHandler' => NULL,
    'MollieMbWayConfig' => NULL,
    'MollieMbWayValidatorPool' => NULL,
    'MollieMbWayCountryValidator' => NULL,
    'MollieMultibancoValueHandlerPool' => NULL,
    'MollieMultibancoConfigValueHandler' => NULL,
    'MollieMultibancoConfig' => NULL,
    'MollieMultibancoValidatorPool' => NULL,
    'MollieMultibancoCountryValidator' => NULL,
    'MollieMyBankValueHandlerPool' => NULL,
    'MollieMyBankConfigValueHandler' => NULL,
    'MollieMyBankConfig' => NULL,
    'MollieMyBankValidatorPool' => NULL,
    'MollieMyBankCountryValidator' => NULL,
    'MolliePaymentlinkValueHandlerPool' => NULL,
    'MolliePaymentlinkConfigValueHandler' => NULL,
    'MolliePaymentlinkConfig' => NULL,
    'MolliePaymentlinkValidatorPool' => NULL,
    'MolliePaymentlinkCountryValidator' => NULL,
    'MolliePaybybankValueHandlerPool' => NULL,
    'MolliePaybybankConfigValueHandler' => NULL,
    'MolliePaybybankConfig' => NULL,
    'MolliePaybybankValidatorPool' => NULL,
    'MolliePaybybankCountryValidator' => NULL,
    'MolliePaypalValueHandlerPool' => NULL,
    'MolliePaypalConfigValueHandler' => NULL,
    'MolliePaypalConfig' => NULL,
    'MolliePaypalValidatorPool' => NULL,
    'MolliePaypalCountryValidator' => NULL,
    'MolliePaysafecardValueHandlerPool' => NULL,
    'MolliePaysafecardConfigValueHandler' => NULL,
    'MolliePaysafecardConfig' => NULL,
    'MolliePaysafecardValidatorPool' => NULL,
    'MolliePaysafecardCountryValidator' => NULL,
    'MolliePointofsaleValueHandlerPool' => NULL,
    'MolliePointofsaleConfigValueHandler' => NULL,
    'MolliePointofsaleConfig' => NULL,
    'MolliePointofsaleValidatorPool' => NULL,
    'MolliePointofsaleCountryValidator' => NULL,
    'MolliePayconiqValueHandlerPool' => NULL,
    'MolliePayconiqConfigValueHandler' => NULL,
    'MolliePayconiqConfig' => NULL,
    'MolliePayconiqValidatorPool' => NULL,
    'MolliePayconiqCountryValidator' => NULL,
    'MolliePrzelewy24ValueHandlerPool' => NULL,
    'MolliePrzelewy24ConfigValueHandler' => NULL,
    'MolliePrzelewy24Config' => NULL,
    'MolliePrzelewy24ValidatorPool' => NULL,
    'MolliePrzelewy24CountryValidator' => NULL,
    'MollieReorderValueHandlerPool' => NULL,
    'MollieReorderConfigValueHandler' => NULL,
    'MollieReorderConfig' => NULL,
    'MollieReorderValidatorPool' => NULL,
    'MollieReorderCountryValidator' => NULL,
    'MollieRivertyValueHandlerPool' => NULL,
    'MollieRivertyConfigValueHandler' => NULL,
    'MollieRivertyConfig' => NULL,
    'MollieRivertyValidatorPool' => NULL,
    'MollieRivertyCountryValidator' => NULL,
    'MollieSatispayValueHandlerPool' => NULL,
    'MollieSatispayConfigValueHandler' => NULL,
    'MollieSatispayConfig' => NULL,
    'MollieSatispayValidatorPool' => NULL,
    'MollieSatispayCountryValidator' => NULL,
    'MollieSofortValueHandlerPool' => NULL,
    'MollieSofortConfigValueHandler' => NULL,
    'MollieSofortConfig' => NULL,
    'MollieSofortValidatorPool' => NULL,
    'MollieSofortCountryValidator' => NULL,
    'MollieSwishValueHandlerPool' => NULL,
    'MollieSwishConfigValueHandler' => NULL,
    'MollieSwishConfig' => NULL,
    'MollieSwishValidatorPool' => NULL,
    'MollieSwishCountryValidator' => NULL,
    'MollieTrustlyValueHandlerPool' => NULL,
    'MollieTrustlyConfigValueHandler' => NULL,
    'MollieTrustlyConfig' => NULL,
    'MollieTrustlyValidatorPool' => NULL,
    'MollieTrustlyCountryValidator' => NULL,
    'MollieTwintValueHandlerPool' => NULL,
    'MollieTwintConfigValueHandler' => NULL,
    'MollieTwintConfig' => NULL,
    'MollieTwintValidatorPool' => NULL,
    'MollieTwintCountryValidator' => NULL,
    'MollieVoucherValueHandlerPool' => NULL,
    'MollieVoucherConfigValueHandler' => NULL,
    'MollieVoucherConfig' => NULL,
    'MollieVoucherValidatorPool' => NULL,
    'MollieVoucherCountryValidator' => NULL,
    'MollieValueHandlerPool' => NULL,
    'MollieConfigValueHandler' => NULL,
    'MollieGenericConfig' => NULL,
    'MollieCommandPool' => NULL,
    'MollieInitializeCommand' => NULL,
    'MollieOrderCommand' => NULL,
    'MollieInitializeRequestBuilder' => NULL,
    'MollieAuthorizeCommand' => NULL,
    'MollieSaleCommand' => NULL,
    'MollieCommandManager' => NULL,
  ...
  array (
    ...
    'Mollie\\Payment\\Ui\\DataProvider\\PaymentReminder\\Listing\\Pending\\Collection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    'PendingPaymentReminderCollection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    'Mollie\\Payment\\Ui\\DataProvider\\PaymentReminder\\Listing\\Sent\\Collection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    'SentPaymentReminderCollection_getCurPage___self' => 
    array (
      4 => 
      array (
        0 => 'currentPageDetection',
    ...
    array (
      ...
      2 => 'mollie_customer_id_extension_attributes',
    ),
    ...
    array (
      ...
      array (
        0 => 'update_newsletter_subscription_on_customer_update',
        1 => 'mollie_customer_id_extension_attributes',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'mollie_customer_id_extension_attributes',
      ),
    ),
    ...
    'Magento\\Catalog\\Model\\Attribute\\Config_getAttributeNames___self' => 
    array (
      4 => 
      array (
        0 => 'mollie_add_mealvoucher_category_to_loaded_attribute',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'mollie_add_paymentfee_extension_attributes',
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        2 => 'mollie_payment_fee_order',
        3 => 'mollie_payment_add_subscription_data',
      ),
    ),
    ...
    'Magento\\Sales\\Api\\OrderManagementInterface_cancel___self' => 
    array (
      2 => 'mollie_order_management-plugin',
    ),
    ...
    'Magento\\Sales\\Model\\Service\\OrderService_cancel_mollie_order_management-plugin' => 
    array (
      4 => 
      array (
    ...
    'Magento\\Quote\\Api\\Data\\CartInterface_addProduct___self' => 
    array (
      1 => 
      array (
        0 => 'mollie_parse_metadata',
      ),
    ),
    'Magento\\Quote\\Api\\Data\\CartItemInterface_representProduct___self' => 
    array (
      4 => 
      array (
        0 => 'mollie_make_recurring_products_unique_in_cart',
      ),
    ),
    ...
    array (
      4 => 
      array (
        0 => 'disable_minification_for_components_js',
        1 => 'braintreeExcludeFromMinification',
      ),
    ),
    'Magento\\Quote\\Api\\PaymentMethodManagementInterface_getList___self' => 
    array (
      4 => 
      array (
        0 => 'mollie_hide_methods_that_are_not_allowed',
        1 => 'mollie_hide_methods_when_cart_contains_recurring_product',
      ),
    ),
    'Magento\\Config\\Model\\Config\\Loader_getConfigByPath___self' => 
    array (
      1 => 
      array (
        0 => 'mollie_load_correct_group',
      ),
    ),
    'Magento\\InstantPurchase\\Controller\\Button\\PlaceOrder_execute___self' => 
    array (
      1 => 
      array (
        0 => 'storeCheck',
      ...
      4 => 
      array (
        0 => 'mollie_add_redirect_url',
      ),
    ),
    'Magento\\InventorySales\\Model\\IsProductSalableForRequestedQtyCondition\\IsSalableWithReservationsCondition_execute___self' => 
    array (
      2 => 'mollie_disable_stock_check_for_admin_orders',
    ),
    'Magento\\CustomerBalance\\Observer\\RevertStoreCreditObserver_execute___self' => 
    array (
      2 => 'mollie_prevent_double_credit_revert',
    ),
